...
function infopreneur_get_custom_css() {
	...
	$css .= sprintf(
		...
		.button, button, .more-link, input[type="submit"], .pagination .current, .edd-submit.button, .edd-submit.button.gray, .edd-submit.button:visited, #edd-purchase-button, .expanding-archives-title a, .widget_categories ul a { background-color: %1$s; border-color: %1$s; border-bottom-color: %2$s; }
		.button:hover, button:hover, .more-link:hover, input[type="submit"]:hover, .edd-submit.button:hover, #edd-purchase-button:hover, .expanding-archives-title a:hover, .widget_categories ul a:hover { background-color: %2$s; border-color: %2$s; }
		',
