...
$summary_type  = $instance['post_content'];
?>
...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	 ...
	 */
	if ( $instance['thumb_align'] != 'disabled' ) {
		echo infopreneur_get_post_thumbnail( array(
			'alignment' => $instance['thumb_align']
		) );
	}
